...
public class Emails {
    ...
    public void pacienteEmail(String destinatario, String usuario, String pacPassword, String nombresPaciente, String apellidosPaciente) throws MessagingException {
        String nombreApellidoPaciente = nombresPaciente + " " + apellidosPaciente;
        ...
        Message message = sendPacienteEmail(session, myAccountEmail, correoDestino, usser, nombreApellidoPaciente, pacContra);
        Transport.send(message);

    }

    public void codigoCita(String destinatario, String usuario, String pacPassword, String nombresPaciente, String apellidosPaciente) throws MessagingException {
        String nombreApellidoPaciente = nombresPaciente + " " + apellidosPaciente;
        String pacContra = pacPassword;
        String usser = usuario;
        ...
        Message message = sendCodigoCita(session, myAccountEmail, correoDestino, usser, nombreApellidoPaciente, pacContra);
        Transport.send(message);

    }

    public void pacienteEmailRecuperacionContraseña(String destinatario, String usuario, String pacPassword, String nombresPaciente, String apellidosPaciente) throws MessagingException {
        String nombreApellidoPaciente = nombresPaciente + " " + apellidosPaciente;
        String pacContra = pacPassword;
        String usser = usuario;
        ...
        Message message = recuperacionContraseñaPaciente(session, myAccountEmail, correoDestino, usser, nombreApellidoPaciente, pacContra);
        Transport.send(message);
    ...
    private static Message sendPacienteEmail(Session session, String myAcount, String destinatario, String usuario, String nombreapellido, String passwordPac) {
        try {
            Message message = new MimeMessage(session);
            message.setFrom(new InternetAddress(myAcount));
            message.setRecipient(Message.RecipientType.TO, new InternetAddress(destinatario));
            ...
            message.setContent("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
                    ...
                    "  <div class=\"v-text-align\" style=\"color: #ffffff; line-height: 170%; text-align: center; word-wrap: break-word;\">\n" +
                    "    <p style=\"font-size: 14px; line-height: 170%;\"><span style=\"font-size: 16px; line-height: 27.2px; font-family: 'trebuchet ms', geneva;\">Es un gusto saludarle \"" + nombreapellido + "\"<br />se detallan su usuario y contrase&ntilde;a para poder</span></p>\n" +
                    "<p style=\"font-size: 14px; line-height: 170%;\"><span style=\"font-size: 16px; line-height: 27.2px; font-family: 'trebuchet ms', geneva;\">ingresar a su perfil de paciente, sera un gusto atenderle.</span></p>\n" +
                    "<p style=\"font-size: 14px; line-height: 170%;\">&nbsp;</p>\n" +
                    "<p style=\"font-size: 14px; line-height: 170%;\"><strong><span style=\"font-size: 16px; line-height: 27.2px; font-family: 'trebuchet ms', geneva;\">Usuario: \"" + usuario + " \"</span></strong></p>\n" +
                    "<p style=\"font-size: 14px; line-height: 170%;\"><strong><span style=\"font-size: 16px; line-height: 27.2px; font-family: 'trebuchet ms', geneva;\">Contrase&ntilde;a: \"" + passwordPac + " \"</span></strong></p>\n" +
                    "<p style=\"font-size: 14px; line-height: 170%;\">&nbsp;</p>\n" +
                    "<p style=\"font-size: 14px; line-height: 170%;\">&nbsp;</p>\n" +
                    "  </div>\n" +
                    "\n" +
    ...
    private static Message recuperacionContraseñaPaciente(Session session, String myAcount, String destinatario, String usuario, String nombreapellido, String passwordPac) {
        try {
            Message message = new MimeMessage(session);
            message.setFrom(new InternetAddress(myAcount));
            message.setRecipient(Message.RecipientType.TO, new InternetAddress(destinatario));
            ...
            message.setContent("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
                    ...
                    "        \n" +
                    "  <div class=\"v-text-align\" style=\"color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word;\">\n" +
                    "    <p style=\"font-size: 14px; line-height: 140%;\"><span style=\"font-family: Lato, sans-serif; font-size: 20px; line-height: 28px;\">Hospital la salud</span></p>\n" +
                    "  </div>\n" +
                    "\n" +
                    "      </td>\n" +
                    "    </tr>\n" +
    ...
    private static Message sendCodigoCita(Session session, String myAcount, String destinatario, String usuario, String nombreapellido, String codigoCitaPaciente) {
        try {
            Message message = new MimeMessage(session);
            message.setFrom(new InternetAddress(myAcount));
            message.setRecipient(Message.RecipientType.TO, new InternetAddress(destinatario));
            ...
            message.setContent("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
                    ...
                    "        \n" +
                    "  <div class=\"v-text-align\" style=\"color: #ffffff; line-height: 170%; text-align: center; word-wrap: break-word;\">\n" +
                    "    <p style=\"font-size: 14px; line-height: 170%;\"><span style=\"font-size: 16px; line-height: 27.2px; font-family: 'trebuchet ms', geneva;\">Es un gusto saludarle \"" + nombreapellido + "\".<br />Se ha agendado una nueva cita.</span></p>\n" +
                    "<p style=\"font-size: 14px; line-height: 170%;\"><span style=\"font-size: 16px; line-height: 27.2px; font-family: 'trebuchet ms', geneva;\">A continuacion le adjuntamos su codigo: <b>" + codigoCitaPaciente + "</b></span></p>\n" +
                    "<p style=\"font-size: 14px; line-height: 170%;\">&nbsp;</p>\n" +
                    "<p style=\"font-size: 14px; line-height: 170%;\"><strong><span style=\"font-size: 16px; line-height: 27.2px; font-family: 'trebuchet ms', geneva;\">Para nosotros es un gusto atenderle, que tenga un excelente dia.</span></strong></p>\n" +
                    "<p style=\"font-size: 14px; line-height: 170%;\">&nbsp;</p>\n" +
                    "<p style=\"font-size: 14px; line-height: 170%;\">&nbsp;</p>\n" +
